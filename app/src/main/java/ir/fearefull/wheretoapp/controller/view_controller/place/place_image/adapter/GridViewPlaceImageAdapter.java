...
import ir.fearefull.wheretoapp.controller.view_controller.place.place_image.FullScreenPlaceImageViewActivity;
...
public class GridViewPlaceImageAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (placeImages.get(position).getImage().contains("media"))
            ...
            Picasso.get().load(Constants.MEDIA_URL + placeImages.get(position).getImage()).resize(imageWidth, imageWidth).into(imageView);
