...
public class FollowersAdapter extends RecyclerView.Adapter<FollowersAdapter.MyViewHolder> {
    ...
    public FollowersAdapter(List<Friend> followerList, User user, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Friend friend = followerList.get(position);
    ...
    class OnFollowClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (followerList.get(position).getIsFollowing() == 0) {
                try {
    ...
    private void followRequest(final int position, final TextView textView) throws JSONException {
        Call<ResponseBody> call = service.followUser(new FollowRequest(user.getPhoneNumber(),
                followerList.get(position).getPhoneNumber()).toRequestBody());
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                followerList.get(position).setIsFollowing(1);
    ...
    private void removeFollowRequest(final int position, final TextView textView) throws JSONException {
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                followerList.get(position).setIsFollowing(0);
