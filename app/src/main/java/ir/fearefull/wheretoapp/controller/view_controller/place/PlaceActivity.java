...
import ir.fearefull.wheretoapp.controller.view_controller.place.fragment.HomeFragment;
import ir.fearefull.wheretoapp.controller.view_controller.place.fragment.MenuFragment;
import ir.fearefull.wheretoapp.controller.view_controller.place.fragment.ReviewFragment;
...
public class PlaceActivity extends AppCompatActivity {
    ...
    private void generateData(PlaceResponse placeResponse) {
        ...
        if (placeResponse.getPlace().getPlaceImage().contains("media"))
            Picasso.get().load(Constants.BASE_URL + placeResponse.getPlace().getPlaceImage()).into(placeImageImageView);
        else
            Picasso.get().load(Constants.MEDIA_URL + placeResponse.getPlace().getPlaceImage()).into(placeImageImageView);
    ...
    private void setupViewPager(MainPager viewPager) {
        ...
        homeFragment = new HomeFragment(user, this.placeResponse);
        menuFragment = new MenuFragment(user, this.placeResponse);
        reviewFragment = new ReviewFragment(user, this.placeResponse);
